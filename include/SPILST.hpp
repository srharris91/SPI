...
namespace SPI{
    ...
    std::tuple<PetscScalar, SPIVec, SPIVec> LSTNP_spatial(SPIparams &params, SPIgrid &grid, SPIbaseflow &baseflow, SPIVec ql=SPIVec(),SPIVec qr=SPIVec()); // spatial non-parallel LST solution
}
#endif // SPILST_H
